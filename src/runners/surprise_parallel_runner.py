    ...
    def run(self, test_mode=False):
        try:
            ...
            while True:
                ...
                _, _, z_outs = self.exp_mac.prior_encoder_forward(self.batch, self.t)
                actions = self.mac.intrinsic_select_actions(z_outs, self.batch, t_ep=self.t, t_env=self.t_env, bs=envs_not_terminated, test_mode=test_mode)
