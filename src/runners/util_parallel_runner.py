    ...
    def run(self, test_mode=False):
        try:
            ...
            while True:
                ...
                _, _, z_outs = self.exp_mac.encoder_forward(self.batch, self.t)
                util_q = self.exp_mac.util_forward(self.batch.batch_size, z_outs)
                actions = self.mac.util_select_actions(util_q, z_outs, self.batch, t_ep=self.t, t_env=self.t_env, bs=envs_not_terminated, test_mode=test_mode)
