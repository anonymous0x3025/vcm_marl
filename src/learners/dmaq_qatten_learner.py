...
class DMAQ_qattenLearner:
    ...
    def sub_train(self, batch: EpisodeBatch, t_env: int, episode_num: int, mac, mixer, optimizer, params, additional_loss=None, intrinsic_rewards=None, z_out=None):
        ...
        for t in range(batch.max_seq_length):
            if z_out is None:
                ...
                agent_outs = mac.intrinsic_forward(z_out[:, t].detach(), batch, t=t)
    ...
    def _train(self, batch: EpisodeBatch, t_env: int, episode_num: int, additional_loss=None, intrinsic_rewards=None, z_out=None):
        self.sub_train(batch, t_env, episode_num, self.mac, self.mixer, self.optimizer, self.params, additional_loss, intrinsic_rewards, z_out)
