...
class COMALearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.agent_optimizer = RMSprop(params=self.agent_params, lr=args.LR, alpha=args.OPTIM_ALPHA, eps=args.OPTIM_EPS)
        self.critic_optimizer = RMSprop(params=self.critic_params, lr=args.CRITIC_LR, alpha=args.OPTIM_ALPHA, eps=args.OPTIM_EPS)
    ...
    def to_device(self):
        self.mac.to_device()
        self.critic.to(device=self.mac.device)
        self.target_critic.to(device=self.mac.device)
